...
app.get('/api/fishersclubs', (req, res) => {
    res.json(fclubs);
});
app.get('/api/hseclubs', (req, res) => {
    res.json(hclubs);
});

app.post('/api/fishersclubs', (req, res) => {
    console.log('Incoming data:', req.body); // Log incoming data
    const newClub = req.body;

    // Validate data
    if (!newClub.name || !newClub.teacher || !newClub.description || !newClub.meetingInfo || !newClub.image) {
...
app.post('/api/fishersclubs', (req, res) => {
    ...
    // Add the new club to the Fishers list
    fclubs.push(newClub);
    res.json(fclubs); // Return the updated list
});

app.post('/api/hseclubs', (req, res) => {
    const newClub = req.body;
    ...
    // Add the new club to the HSE list
    hclubs.push(newClub);
    res.json(hclubs); // Return the updated list
});
